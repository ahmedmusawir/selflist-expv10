...
<section id="list-insert-user-validation-box" class="card p-5 animate__animated animate__zoomIn d-none">
    ...
    <ul class="list-group">
        ...
        <li class="list-group-item">Phone: <span class="pl-3 font-weight-bold" id="list-user-validation-phone"></span>
        </li>
        <li class="list-group-item">Website: <span class="pl-3 font-weight-bold"
                id="list-user-validation-website"></span>
        </li>
        <li class="list-group-item">City: <span class="pl-3 font-weight-bold" id="list-user-validation-city"></span>
        </li>
        <li class="list-group-item">State: <span class="pl-3 font-weight-bold" id="list-user-validation-state"></span>
        </li>
        <!-- SOCIAL MEDIA LINKS -->
