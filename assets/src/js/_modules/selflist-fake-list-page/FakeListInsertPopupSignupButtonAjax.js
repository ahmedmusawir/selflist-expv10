...
class FakeListInsertPopupSignupButtonAjax extends FakeListInsertValidationEvents {
  constructor() {
    super();
    // this.init();
    ...
    // COLLECTING ELEMENTS
    this.listInsertButton = $('#fake-list-insert-popup-signup-btn');
  ...
  init = () => {
    console.log('FakeListInsertPopupSignupButtonAjax - Insert Post');
  };
...
export default FakeListInsertPopupSignupButtonAjax;
